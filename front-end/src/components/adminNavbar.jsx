    ...
    return ( 
        <nav>
            ...
            <div className='2xl:hidden p-4 bg-black flex justify-between text-white'>
                ...
                <span className='hidden italic sm:inline-block sm:text-3xl mr-10 px-2 py-0.5 cursor-pointer border rounded-2xl border-black hover:bg-gray-800 font-extrabold'>Admin</span>
